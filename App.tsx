...
import { UserLifestyleData, ActivityLevel, RiskLevel, PredictionResult, DemographicStat } from './types';
import { calculateBMI, predictLifestyleRisk, getSyntheticDemographics } from './utils/calculations';
